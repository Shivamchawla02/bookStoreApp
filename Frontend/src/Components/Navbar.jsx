...
function Navbar() {
  ...
  <div className="navbar-start">
    ...
    <Link to="/" className=" cursor-pointer w-40 dark:bg-slate-800 dark:text-white "><img src="https://usoindia.org/wp-content/uploads/2022/03/CSIR-NISCPR.png" alt="" /></Link>
  </div>
